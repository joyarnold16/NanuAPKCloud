...
TAG="nanu-ai-trading-bot-v6-8-oco-safety"
APK="nanu-ai-trading-bot-v6-8-oco-safety.apk"
...
if gh release view "$TAG" -R "$REPO" >/dev/null 2>&1; then
  echo "The v6.8 OCO Safety release already exists. Downloading it now."
else
  echo "Starting the signed Nanu AI Trading Bot v6.8 build..."
