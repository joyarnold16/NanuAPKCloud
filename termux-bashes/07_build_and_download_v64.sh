...
TAG="nanu-ai-trading-bot-v6-4-tablet-edition"
...
if gh release view "$TAG" -R "$REPO" >/dev/null 2>&1; then
  echo "The Tablet Edition release already exists. Downloading it now."
else
  echo "Starting the signed Nanu Tablet Edition APK build..."
