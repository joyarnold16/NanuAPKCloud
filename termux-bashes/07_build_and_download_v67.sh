...
TAG="nanu-ai-trading-bot-v6-7-device-safety"
...
if gh release view "$TAG" -R "$REPO" >/dev/null 2>&1; then
  echo "The v6.7 Device Safety release already exists. Downloading it now."
else
  echo "Starting the signed Nanu AI Trading Bot v6.7 build..."
