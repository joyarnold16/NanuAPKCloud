...
for name in ['ChatStore.kt', 'LocalTaskService.kt', 'TaskScreenSession.kt', 'ImageEditInput.kt', 'LocalRagEngine.kt', 'NanuToolRegistry.kt', 'OnlineToolClient.kt', 'TarotDeck.kt', 'TarotActivity.kt', 'ProEntitlement.kt', 'ProBilling.kt', 'ProStore.kt', 'ProActivity.kt']:
