...
for name in ['ChatStore.kt', 'LocalTaskService.kt', 'TaskScreenSession.kt', 'ImageEditInput.kt', 'LocalRagEngine.kt', 'NanuToolRegistry.kt', 'OnlineToolClient.kt', 'NanuPulseView.kt', 'TarotDeck.kt', 'TarotActivity.kt', 'ProEntitlement.kt', 'ProBilling.kt', 'ProStore.kt', 'ProActivity.kt']:
...
if 'com.android.billingclient:billing:' not in text:
    text = text.replace('dependencies {', 'dependencies {\n    implementation("com.android.billingclient:billing:8.0.0")', 1)
