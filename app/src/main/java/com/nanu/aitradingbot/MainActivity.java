...
public class MainActivity extends Activity {
    ...
    void footer() { addGap(14); TextView f = tv("Nanu AI Trading Bot v5.2 • Paper first • Live locked • Panic always available", 11, MUTED, false); f.setGravity(Gravity.CENTER); root.addView(f); }
