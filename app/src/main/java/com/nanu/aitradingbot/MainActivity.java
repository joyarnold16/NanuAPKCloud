...
public class MainActivity extends Activity {
    ...
    void buildLiveChecklist(LinearLayout box) {
        ...
        list.addView(tv("Live unlock will remain blocked until every checklist item passes. This protects your Binance account from accidental unsafe live trading.", 11, AMBER, false));
        box.addView(list);
    }
    ...
    void unlockLive() {
        ...
        if (!missing.isEmpty()) {
            alert("Live Unlock Blocked", "Nanu will not unlock live auto trading yet. Fix these items first:\n\n" + missing + "\nThis is intentional safety protection for your Binance account.");
            return;
        }
    ...
    void footer() { addGap(14); TextView f = tv("Nanu AI Trading Bot v5.5 • Final Safety Polish • One Dialog • Live Checklist", 11, MUTED, false); f.setGravity(Gravity.CENTER); root.addView(f); }
