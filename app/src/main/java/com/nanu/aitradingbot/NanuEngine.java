...
public class NanuEngine {
    ...
    public NanuEngine(AppStore s) {
        store = s;
        seed();
        addJournal("Nanu v5 ready in Paper Mode.");
    }
    ...
    public void resetPaper() {
        running = false; panic = false; equity = 1000; todayPnl = 0; openPnl = 0; winRate = 72; trades.clear(); seed();
    ...
    private void buildBrain() {
        ...
        brain.add("Risk Shield: " + (panic ? "PANIC active" : "Daily loss and open-trade limits monitored."));
