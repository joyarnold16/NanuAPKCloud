...
public class OrderSafetyEngine {
    ...
    public static Preview buildDryRunPreview(AppStore store) {
        ...
        out.append("Nanu Order Safety Engine v5.6.3\n\n");
        ...
        if (ok) {
            out.append("Nanu is allowed to simulate the order path only. Real order placement remains blocked in v5.6.3.\n");
        ...
        out.append("\nSafety note: v5.6.3 does not place real live orders. It previews, validates and logs the order plan.");
